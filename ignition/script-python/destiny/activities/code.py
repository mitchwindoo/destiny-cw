		...
		if len(Response) > 0:
			...
			for activity in activities:
				...
				if activityExists == False:
					...
					logger.info("ironBanner: Activity ID " + str(activity['activityDetails']['instanceId']) + " does not exist in database")
					...
					if dataCurrent == True:
						...
						logger.info("ironBanner: Activity ID " + str(activity['activityDetails']['instanceId']) + " data is being added to the database")
						...
						logger.info("ironBanner: Activity ID " + str(activity['activityDetails']['instanceId']) + " being skipped due to age")
				else:
					print "ironBanner: Activity ID " + str(activity['activityDetails']['instanceId']) + " Has already been logged to the database"
					logger.info("ironBanner: Activity ID " + str(activity['activityDetails']['instanceId']) + " Has already been logged to the database")
	except:
